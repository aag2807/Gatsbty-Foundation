        ...
        <SectionTwo>
          <div>
            ...
            <GenericPara lessSize>
              ...
              get paid, but because it's fun to program.
            </GenericPara>
          ...
          <FlexBoxIndex>
            ...
            <div className="text__section3">
              ...
              <GenericPara lessSize lessSpacing>
                We hand code beautiful websites using HTML, CSS & plain JS to
                make them efficient, no WordPress/Wix websites here
              </GenericPara>
            </div>
          </FlexBoxIndex>
          ...
          <div className="grid__section4">
            <div className="item1" style={{ backgroundColor: "#4D508E" }}>
              ...
              <GenericPara lessSize lessSpacing grey>
                Modern JS framework which will make web apps fast and reliable
                for every User.
              </GenericPara>
            </div>
            ...
            <div className="item3" style={{ backgroundColor: "#484A83" }}>
              ...
              <GenericPara lessSize lessSpacing grey>
                The one language to rule them All, The modern language of the
                web. It is used for web development, Mobile, IOT, Games etc.
              </GenericPara>
            </div>
